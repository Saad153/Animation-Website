...
const TEAM: Member[] = [
  ...
  { sr: 3,  name: "Adil Mehmood",       designation: "Project Manager",        education: "D.A.E. (Civil)",              hasPhoto: false },
  { sr: 4,  name: "M. Farhan Karamat",  designation: "Architect/Project Manager",       education: "B. Arch.",                  hasPhoto: false },
  ...
  { sr: 11, name: "Mikael A. Bhurgri",  designation: "Senior Architect",      education: "B. Arch.",                  hasPhoto: false },
  ...
  { sr: 19, name: "Aliza Salman",       designation: "Interior Architect",             education: "B. Arch.",                  hasPhoto: false },
  { sr: 20, name: "Sahar Khan",         designation: "Interior Architect",             education: "B. Arch.",                  hasPhoto: false },
  // { sr: 21, name: "Adil Mehmood",       designation: "Quantity Surveyor",     education: "",            hasPhoto: false },
