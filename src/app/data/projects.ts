...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      ...
      We designed it from the very start, complete with its iconic design, architecture, monument, welcome centre, interiors, and landscaping, making this 26 acre park a unique IT park, whose design elements were then repeated in Lahore and Karachi. 

      The prefab buildings, with its alucobond cladding were executed at site by outsourcing contractors while the furniture was made by Gravity and sent. 

      The individual offices of international companies were done by the clients themselves while all the airforce offices with the different departments in the first 7 Alphas were designed and executed by Gravity. 
